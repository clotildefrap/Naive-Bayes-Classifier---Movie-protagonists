...
def determine_gender(name_dir):
    ...
    characters_file = os.path.join(name_dir, "Keywords", "characters_function.txt")
    preprocessed_texts_path = os.path.join(name_dir, "function_wd", "Movies")
    gender_base_path = os.path.join(name_dir, "function_wd", "Gender_based_texts")
